...
public class ResumeController {
    ...
    @ApiMessage("Count resumes")
    public ResponseEntity<Long> countResumes() {
        return ResponseEntity.ok().body(this.resumeService.countResumes());
    }

    @GetMapping("/resumes/details")
    @ApiMessage("Lấy chi tiết hồ sơ của người dùng hiện tại")
    public ResponseEntity<List<ResumeDetailDTO>> getResumeDetails() {
        String email = SecurityUtil.getCurrentUserLogin()
            .orElseThrow(() -> new RuntimeException("Không tìm thấy người dùng hiện tại"));
        List<ResumeDetailDTO> resumeDetails = resumeService.getResumeDetailsByUserEmail(email);
